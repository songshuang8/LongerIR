...
public class DragGridViewLearn  extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener{
    ...
    public DragGridViewLearn(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected Runnable updateTask = new Runnable() {
        public void run() {
            ...
            clampScroll();
            if(studying && flash_cnt++>5 && selected>=0){
    ...
    public void setCurrIrData(byte[] decode){
        ...
        for (int i = 0; i < paramlen; i++) {
            ...
            viewInfo.param16 += Integer.toHexString(viewInfo.params[i]&0xffffffff)+",";
        }
        getChildAt(selected).setVisibility(View.VISIBLE);
        selected++;
