...
public class CharacterParser {
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            Log.w(TAG_SS,"ERROR:ChineseSpelling.class-getChsAscii(String chs)" + e);
        }
        return asc;
    }
    ...
    public String getFirstLetter(String src) {
        String ret;
        String pinyin = getSelling(src);
        String sortString = pinyin.substring(0, 1).toUpperCase();
        // 正则表达式，判断首字母是否是英文字母
        if (sortString.matches("[A-Z]")) {
            ret = sortString.toUpperCase();
        } else {
            ret = "#";
        }
        return ret;
    ...
    public static void sortListIgnoreCase(List<String> list) {
